...
const create_todo_dto_1 = require("../common/dto/create-todo.dto");
const update_todo_dto_1 = require("../common/dto/update-todo.dto");
let TodosController = class TodosController {
    todosService;
    constructor(todosService) {
        this.todosService = todosService;
    }
    findAll(moduleId, completed) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TodosController.prototype, "toggleComplete", null);
